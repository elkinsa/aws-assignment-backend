...
@WebServlet("/getmyreimbs")
public class GetMyReimbursementsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static ReimbursementService ReimbursementService = new ReimbursementService();
 
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Reimbursement> reimbursements = ReimbursementService.getMyReimbursements(request.getParameter("status"),Integer.parseInt(request.getParameter("userId")));
